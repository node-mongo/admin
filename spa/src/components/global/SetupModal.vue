<!--
  ...
  - @version      SetupModal.vue 1001 15/9/21, 12:17 pm  Gilbert Rehling $
...
<template>
    <div id="register-modal" v-if="show" v-on:click="closeDialogOutside($event)">
        ...
        */
        ...
        methods: {
            ...
            closeDialogOutside( event ) {
              if (window.$(event.target).is('#login-modal')) {

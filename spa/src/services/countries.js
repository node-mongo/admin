 ...
 * @version      countries.js 1001 15/9/21, 12:17 pm  Gilbert Rehling $
 * @package      NodeMongoAdmin\Spa
 * @subpackage   countries.js
...
export default function makeCountries( ) {
    /**
    ...
    store.dispatch('setCountries', countries)
        .then(() => {
            output = store.getters.getCountries;
        });
